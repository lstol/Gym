...
|---|---|---|---|
| 1 | 0 + 1 | Repo scaffold (Vite+React+TS+Tailwind+TanStack Query+vite-plugin-pwa), CI-ready lint/typecheck/test, Netlify config, machine/station/exercise/program schema + RLS, seed data, email+password auth with forced first-login change, empty app deployed | You can log in at gym.syndikatet.eu and see Blokk 1's program |
